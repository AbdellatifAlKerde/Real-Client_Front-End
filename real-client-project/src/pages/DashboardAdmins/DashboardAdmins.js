...
function DashboardAdmins() {
  ...
  const getAdmins = async () => {
    ...
    try {
      ...
      setAdminsCount(response.data.totalItems);
  ...
  return (
    <div className="dashboard-admins onLoad">
      ...
      {/* <div className="dashboard-admins-heading">
        <h2>Admins</h2>
      </div> */}
      {/* <div className="dashboard-admins-form"> */}
      {/* <div style={{ display: "flex", columnGap: "10px", flexWrap: "wrap" }}>
          <form onSubmit={isEdit ? editAdmin : addAdmin}>
            <div style={{ color: "var(--accent-color)" }}>{error}</div>
            <div>
              <TextField
                label="Full Name"
